/**
 * Classe permettant de gérer une Pile de valeurs entiéres.
 * L'accés est LIFO (Last In First Out).
 * Exemple :
		 Pile p;
		 p = new Pile();
		 p.empiler(10);
...
public class Pile {
	...
	public void empiler(int pfElement) throws Exception {
		if (this.estPleine()) throw new Exception("La pile est pleine");
	...
	public void depiler() throws Exception {
		if (this.estVide()) throw new Exception("La pile est vide");
		this.indiceSommet = this.indiceSommet - 1;
	}
